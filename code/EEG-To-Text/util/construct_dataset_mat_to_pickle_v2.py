...
# rootdir = r"D:\Vijay\NYU\Spring_25\BDMLS\Project\dataset\ZuCo\2urht\osfstorage\task1 - NR\Matlab files"
rootdir = r"/scratch/vjh9526/bdml_2025/project/datasets/ZuCo2/2urht/osfstorage/task1 - NR/Matlab files"

print('##############################')
print(f'start processing ZuCo task1-NR-2.0...')
...
output_dir = r'/scratch/vjh9526/bdml_2025/project/datasets/ZuCo2/2urht/osfstorage/task1 - NR/npy_file'
...
# save as .npy instead of .pickle
output_name = f'{task_name}-dataset.npy'
np.save(
    os.path.join(output_dir, output_name),
    dataset_dict,
    allow_pickle=True        # <-- needed for arbitrary Python objects
)
print('wrote to:', os.path.join(output_dir, output_name))
